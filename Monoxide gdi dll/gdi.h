...
#pragma once
	...
	__declspec(dllexport) VOID GdiThreadStart(INT number);
	__declspec(dllexport) VOID CursorDraw(VOID);
	__declspec(dllexport) VOID MsgBoxThread(VOID);
	__declspec(dllexport) VOID EnumGlobalWnd(VOID);
	__declspec(dllexport) VOID Initialize(VOID);
	__declspec(dllexport) VOID AllGdiStart();
